...
Si \(X_1, \ldots, X_2 \sim f_{\theta} \) i.i.d, con \(\mathrm{Var}(X) = \sigma^2\) y media $\theta$, recuerde que el estimador \(\hat{\theta}\)  de \(\theta\) tiene la característica que
...
\end{equation*}
con \(u = \frac{x-xi}{h}\), entonces parte del estimador de histograma se puede escribir como:
\begin{equation*}
