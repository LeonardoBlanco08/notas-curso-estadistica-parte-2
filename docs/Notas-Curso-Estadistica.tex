...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1228}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2982}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2982}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0877}}@{}}
\toprule()
\endhead
& & \textbf{Clase} & \textbf{Predicción} & \\
& & 0 & 1 & \\
\textbf{Clase} & 0 & Verdaderos Negativos. (TN) & Falsos Positivos (FP) & \(N\) \\
...
\tightlist
\item
  \textbf{Sensibilidad} es importante si la ocurrencia de \textbf{falsos negativos} es inaceptable. Por ejemplo en el caso de pruebas clínicas. Posiblemente obtener falsos positivos en este caso es aceptable.
\item
