...
\NormalTok{        Tboot_bm[m] <-}\StringTok{ }\KeywordTok{var}\NormalTok{(xbm)}
\NormalTok{    \}}
\NormalTok{    sdboot_b[b] <-}\StringTok{ }\KeywordTok{sd}\NormalTok{(Tboot_bm)}
\NormalTok{\}}
...
\BeginKnitrBlock{exercise}
\protect\hypertarget{exr:unnamed-chunk-171}{}{\label{exr:unnamed-chunk-171} }Encuentre la varianza para \(\beta_{0}\) y \(\beta_{1}\) para el caso de la regresión simple.
\EndKnitrBlock{exercise}
