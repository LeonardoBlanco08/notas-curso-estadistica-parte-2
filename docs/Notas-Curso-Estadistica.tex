...
\chapter{Aprendizaje estadístico}\label{aprendizaje-estaduxedstico}}
...
\StringTok{# # Guardar el gráfico en un archivo pdf}
\StringTok{# ggsave(filename = 'linear_reg_con_IC_IP.pdf') #}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{posibles-problemas-en-los-supuestos-para-regresion-lineal}{%
\section{Posibles problemas en los supuestos para regresion lineal}\label{posibles-problemas-en-los-supuestos-para-regresion-lineal}}

\hypertarget{no-linealidad-de-los-datos}{%
\subsection{No linealidad de los datos}\label{no-linealidad-de-los-datos}}
