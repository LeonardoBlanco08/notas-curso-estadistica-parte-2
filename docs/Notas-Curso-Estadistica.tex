...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-70}{}\label{exm:unnamed-chunk-70}Una forma fácil de construir los \(T_{(-i)}\) es primero replicando
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-74}{}\label{exm:unnamed-chunk-74}En nuestro caso tendríamos lo siguiente:
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-79}{}\label{exm:unnamed-chunk-79}Los pseudo-valores se estiman de forma directa como,
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-89}{}\label{exm:unnamed-chunk-89}En este ejemplo podemos tomar \(B=1000\) y construir esa cantidad de veces nuestro estimador de varianza:
\end{example}
